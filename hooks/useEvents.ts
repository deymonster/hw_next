/**
 * Хук `useEvents` предоставляет единый интерфейс для работы с событиями
 * пользователей: загрузка, отметка как прочитанные, подсчёт непрочитанного
 * и управление состояниями загрузки/ошибок.
 */
