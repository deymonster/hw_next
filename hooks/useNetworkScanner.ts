...
import { scanNetwork, findAgentByKey, getCurrentSubnet, cancelScan } from '@/app/actions/network-scanner'
...
export function useNetworkScanner() {
    ...
    const startScan = useCallback(async (
        ...
        try {
            ...
            console.log('[NETWORK_SCANNER] Scan completed, received agents:', agents)
            ...
            console.log('[NETWORK_SCANNER] Setting discovered agents:', agents)
