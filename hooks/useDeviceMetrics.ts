...
import { DeviceMetrics, MetricsResponse } from '@/services/prometheus/prometheus.interfaces'
                ...
                try {
                    ...
                    switch (response.type) {
                        ...
                        case'dynamic':
                            currentMetrics = {
                                ...currentMetrics,
                                processorMetrics: response.data.processorMetrics,
                    ...
                    if (currentMetrics.systemInfo && currentMetrics.hardwareInfo) {
