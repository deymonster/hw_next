...
export function SessionsList() {
    ...
    const { sessions: dataSessions, loading: isLoadingSessions, getCurrentSession, fetchSessions } = useSessionManager()
    ...
    <div className='space-y-4'>
        ...
        {isLoadingSessions ? <ToggleCardSkeleton /> : (
        ...
        {isLoadingSessions ? (
            ...
            <div className='text-muted-forengorund'>{t('info.notFound')}</div>
        )}
    </div>
    )
}