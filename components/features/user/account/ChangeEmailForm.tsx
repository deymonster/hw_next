...
import { type TypeChangeEmailSchema, changeEmailSchema } from "@/schemas/user/change-email.schema"
        ...
        <FormWrapper heading={t('heading')}>
            <Form {...form}>
                <form className="grid gap-y-3">
                            ...
                            <FormItem className='px-5'>
                                ...
                                <FormControl>
                                    <Input 
                                        ...
                                        disabled={isPending || changeState !== 'idle'}
                                        {...field}
                                    /> 
                                </FormControl>
                                <FormDescription>
                    ...
                    {(changeState === 'verification_sent' || changeState === 'verified') && (
                        <FormField 
                            control={form.control}
                                ...
                                <FormItem className='px-5'>
                                    ...
                                    <FormControl>
                                        <Input 
                                            ...
                                            disabled={isPending || changeState === 'verified'}
                                            {...field}
                                        /> 
                                    </FormControl>
                                    <FormDescription>
                            ...
                            <div className="flex gap-x-3">
                                ...
                                {changeState === 'verification_sent' ? (
                                    <Button 
                                        ...
                                        disabled={!verificationCode || isPending}
                                    >
                                        {isPending ? (
                                            <>
                                                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
