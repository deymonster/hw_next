        ...
        <div className='px-2 sm:px-4 lg:px-10'>
            ...
            <Tabs defaultValue="rules" className="mt-4 sm:mt-6">
                <TabsList className="grid w-full grid-cols-2 h-9 sm:h-10">
                    <TabsTrigger value="rules" className="text-xs sm:text-sm">{t('tabs.rules')}</TabsTrigger>
                    <TabsTrigger value="events" className="text-xs sm:text-sm">{t('tabs.events')}</TabsTrigger>
                </TabsList>
