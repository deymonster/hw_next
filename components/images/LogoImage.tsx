        ...
        >
            ...
            <g>
                ...
                <g id='screen-content'>
                    ...
                    />
                    {/* Точки данных */}
                    <circle cx='900' cy='800' r='120' className='fill-primary'/>
                    <circle cx='1300' cy='1400' r='120' className='fill-primary'/>
                    <circle cx='1700' cy='600' r='120' className='fill-primary'/>
                </g>
                {/* Подставка монитора */}
                <path
                    className='fill-primary'
