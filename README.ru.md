...
### Переменные окружения для сетевого сканера

Список переменных, влияющих на работу `NetworkScannerService`, приведён в [docs/network-scanner-env.md](docs/network-scanner-env.md).
